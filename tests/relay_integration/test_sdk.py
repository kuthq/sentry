...
@no_silo_test
@override_settings(SENTRY_PROJECT=1, SENTRY_ORGANIZATION_CONTEXT_HELPER=add_context)
@django_db_all
...
def broken_add_context(scope, organization, **kwargs):
    1 / 0


@no_silo_test
@override_settings(SENTRY_PROJECT=1, SENTRY_ORGANIZATION_CONTEXT_HELPER=broken_add_context)
@django_db_all
